...
var pruhlednost = 1;
  ...
  pruhlednost = pruhlednost - 1;
  document.getElementById('hlavniDiv').style.opacity = (pruhlednost >= 10) ? '0.' + pruhlednost : '0.0' +pruhlednost;
  if (pruhlednost <=2) window.location.href = "index.html";
    } else if (eBool==3) {
      pruhlednost = pruhlednost - 1;
      document.getElementById('hlavniDiv').style.opacity = (pruhlednost >= 10) ? '0.' + pruhlednost : '0.0' +pruhlednost;
      if (pruhlednost <=2) window.location.href = "cvicitDefinice.html";
        }
   else if (eBool==4) {
        pruhlednost = pruhlednost - 1;
        document.getElementById('hlavniDiv').style.opacity = (pruhlednost >= 10) ? '0.' + pruhlednost : '0.0' +pruhlednost;
        if (pruhlednost <=2) window.location.href = "cvicitNaPrikladech.html";
          }
           else return;
  };